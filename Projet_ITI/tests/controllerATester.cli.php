...
class testDefaultCtrl extends UnitTestCase {
    ...
    function testInscriptionValidee() {
        jAuth::logout();
    ...
    function testSaveModifUtilisateur() {
    ...
    function testSaveModifAnnoncePrix() {
    ...
    function testRechercherDesAnnonces(){
        $rep = $this->getResponse('html');
        $rep->bodyTpl="accueilCompte";
    ...
    function testAfficherToutesLesAnnonces() {
        $rep = $this->getResponse('html'); 
    ...
    function testAfficherAnnonceRecherchees() {
        $rep = $this->getResponse('html'); 
